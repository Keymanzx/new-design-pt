    ...
    <>
      <div className="bg-[#2D2B49] px-4 py-4 rounded-xl">
        <div class="relative flex h-10 w-full min-w-[200px] ">
          ...
          <input
            type="email"
            class="peer h-full w-full rounded-3xl border border-blue-gray-200 bg-white px-3 py-2.5 pr-20 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-amber-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            placeholder=" "
            required
          />
